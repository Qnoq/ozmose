      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          ...
          <ThemedText style={[styles.subtitle, { color: textColor }]}>
            Gérez vos amis et trouvez de nouveaux compagnons de défis
          </ThemedText>
        </View>

        <View style={[styles.emptyState, { backgroundColor: cardColor }]}>
          <IconSymbol name="people" size={64} color="#9CA3AF" />
          <ThemedText style={styles.emptyStateText}>
            Aucun ami pour le moment
          </ThemedText>
          <ThemedText style={[styles.emptyStateSubtext, { color: textColor }]}>
            Invitez vos amis à rejoindre Ozmose pour partager des défis !
          </ThemedText>
        </View>
